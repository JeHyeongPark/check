...
<!--  -->
  <jsp:include page="sideBar.jsp" flush="false" />
	...
	<div id="contents">     
			...
			<form action="/Zspace/updatePro1.do?post_num=${article.post_num }&pageNum=${pageNum }&post_date=${article.post_date }" method="post">
				<input type="hidden" name="pageNum" value="1">
				<input type="hidden" name="post_num" value="${article.post_num}">
				<input type="hidden" name="admin_id" value="123">
