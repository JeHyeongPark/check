...
<p>
<!-- 검색구역 -->
  <form id="faqPost_boardSearchForm" method="post"  action="/Zspace/list1.do?post_num=1&pageNum=1" >
  	<div class="faqPost_bottomsearch">
       <input type="text" class="form-control" placeholder="검색어 입력" name="searchtext" >
