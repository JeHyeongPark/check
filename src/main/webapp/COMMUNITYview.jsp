		...
		<div class="community_notice_reply">
			<table class="community_notice_reply_table">
				...
				<tr class="community_notice_reply_tr">
					<td class="community_notice_nickname">${mem_id}</td>
					<td class="community_notice_reply_text">${reply_cnt}</td>
					<td class="community_notice_date"><fmt:formatDate value="${reply_date}" timeStyle="medium"  pattern="yy.MM.dd  (hh:mm)"/></td>
					<td align=right>
			...
			<form method="post" name="add_form" action="/Zspace/ReplyPro6.do">
				<table class="community_notice_reply_write">
					...
					<td class="community_notice_nickname">
						<input type="hidden" name="mem_id" size="10" value="test">&nbsp;test
