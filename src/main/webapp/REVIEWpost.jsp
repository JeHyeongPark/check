...
<div id="contents">
  <div id="reviewPost_header">
	...
	<button button class="btn btn-primary btn-xl" onclick="location.href='/Zspace/writeForm4.do'">글쓰기</button><p>
		<div>
			<table class="table">
			...
			<c:forEach var="article" items="${articleList}">
				<tr class="text-center">
					...
					<td>
					  <fmt:formatDate value="${article.post_date}" timeStyle="medium" pattern="yy.MM.dd" />
					</td>
					<td>${article.rated}</td>
				</tr>
			 </c:forEach>
