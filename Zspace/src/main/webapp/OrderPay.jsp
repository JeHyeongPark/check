...
﻿<link href="https://fonts.googleapis.com/icon?family=Material+Icons|Material+Icons+Outlined|
			...
			<script>
			request.getParameter("item_su");
			 var pay_amt = 0; // pay_amt 초기값 설정
			 var pay_total=0;
			 pay_amt += order.item_pay * order.item_su;
			 pay_total +=pay_amt+3000;
			</script>
</head>
<body>
<jsp:include page="sideBar.jsp" />
  ...
  <div id="contents">
    ...
    <form class="order_pay_fm" method="post" action="/Zspace/orderPro.do?pay_num=${pay_num}&mem_id=${mem_id}">
...
<!-- 	<form class="order_pay_fm"> -->
	   ...
	   <tr>
	     ...
	     <td>
	       <div class="pay_bodytable2area">
	         <input type="text" id="mem_name" size="15" name="mem_name" value="${order.mem_name}" onkeydown="checkSpacebar();">
	   ...
	   <tr>
		 ...
		 <td>
		  <div class="pay_bodytable3area"><p>
		    <input size="6" maxlength="6" type="text" name="mem_zipcode" id="mem_zipcode" value="${order.mem_zipcode}"> 
		     <button class="btn btn_default">우편번호</button>
		    <p>
		    <input size="40" name="mem_addr1" id="mem_addr1" type="text" value="${order.mem_addr1}">
		   
		     <span class="grid">기본 주소</span>
		     <span class="error" id="addr_error">기본 주소를 입력해주세요.</span>
		    <p>
		    <input size="40" name="mem_addr2" id="mem_addr2" type="text" value="${order.mem_addr2}"> 
	   ...
	   <tr>
	     ...
	     <td>
	       <div class="pay_bodytable5area">
	         <input size="13" name="mem_phone" id="mem_phone" type="text" value="${order.mem_phone}">
	...
	<div class="pay_bottomleft"><p> <!-- 결제 수단 -->
	  <label><input type="radio" id="payment" name="pay_meth">카드 결제</label><p>
	  <label><input type="radio" id="payment" name="pay_meth">휴대폰 결제</label><p>
	  <label><input type="radio" id="payment" name="pay_meth">무통장 입금</label><p>
	  <label><input type="radio" id="payment" name="pay_meth">삼성 페이</label><p>
	</div>
	...
	<div class="pay_bottomright"> <!-- 결제금액 -->
	 ...
	 <div class="pay_last">
	   <font size="5pt"> 결제 금액= &nbsp; 
	     ...
	     <fmt:formatNumber value="${pay_total}" pattern="#,###" />원</font><p>
