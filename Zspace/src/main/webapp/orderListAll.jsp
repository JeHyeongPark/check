...
<body>
	...
	<div id="contents">
		<!-- 탭 부분 -->
		<div class="container2"> <!-- 부트충돌나는부분 
		OrderCheck.do?mem_id=${mem_id}&id=tab2  mem_id=${mem_id}&id=tab1
		.do?mem_id=${mem_id}&id=tab3
		.do?mem_id=${mem_id}&id=tab4
		class="tablinks" onclick="openTab(event, 'tab1'); $("#tab2_search").trigger('click');"
		-->
				...
				<div class="calendar">
			         ...
			         <input type="hidden" name="mem_id" value="${mem_id}">
				        ...
				        <input type="date" id="startDate" name="startDate" value="${startDate}"  
				        	max="2080-12-22" min="2008-11-02"   style="line-height: 18px; width: 100PX;" >
			          - 
				        <input type="date" id="endDate" name="endDate" value="${endDate}"  
				        	max="2080-12-22" min="2008-11-02" style="line-height: 18px; width: 100PX;" >
			         <input type="submit" id="order1" value="조회">
			     </div>    	
			       ...
			       <!--  -->
					...
					<%-- <c:if test="${ord.order_date >= startDate}"> --%>
				     	<tr height="40px" class="text-center">
					        ...
					        <img  src="${ord.item_img}(1).jpg" width="125" alt="#" /> </td>
					        <td align="center">${ord.item_name}</td>
					        <td align="center">${ord.item_su}</td>
 					        <td align="center">
					        <fmt:formatNumber value="${ord.pay_total}" pattern="#,###" /> 
					        </td>
					    </tr> 
				    </c:if>
				</c:forEach >		    
			...
			<div id="tab-2" class="tab-content">
				...
				<input type="date" id="startDate" name="startDate" value="${startDate}"  
			          ...
			          - 
				        <input type="date" id="endDate" name="endDate" value="${endDate}"  
				        	max="2080-12-22" min="2008-11-02" style="line-height: 18px; width: 100PX;" >
			         <input type="submit" id="order1" value="조회"><p>
        </div>
					<tr id="admin_page_tr" height="30px">
			     ...
			     <c:forEach items="${exchangeList}" var="ecl">
					...
					<tr height="40px" class="text-center">
						...
						<td style="line-height: 0" align="center">
						<img  src="${ecl.item_img}(1).jpg" width="125" alt="#" /></td>
